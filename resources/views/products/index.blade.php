...
<div class="row mb-4">
    ...
    <div class="col-md-2">
        <button class="btn btn-outline-secondary w-100" id="price-filter-btn" data-bs-toggle="modal" data-bs-target="#priceFilterModal">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <button class="btn btn-outline-secondary btn-sm" id="sort-order" data-order="desc" title="Sort Direction">
                        <i class="fas fa-sort-amount-down"></i>
                    </button>
                </div>
                <!-- View Toggle -->
                <div class="btn-group" role="group" aria-label="View toggle">
                    <input type="radio" class="btn-check" name="view" id="grid-view" value="grid" autocomplete="off" checked>
                    <label class="btn btn-outline-secondary btn-sm" for="grid-view">
                        <i class="fas fa-th"></i> Grid
                    </label>
                    <input type="radio" class="btn-check" name="view" id="list-view" value="list" autocomplete="off">
