            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                <a href="{{ route('orders.show', 1001) }}" class="btn btn-sm btn-outline-info"
                                   title="View">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('orders.edit', 1001) }}" class="btn btn-sm btn-outline-warning"
                                   title="Edit">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                <a href="{{ route('orders.show', 1002) }}" class="btn btn-sm btn-outline-info"
                                   title="View">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('orders.edit', 1002) }}" class="btn btn-sm btn-outline-warning"
                                   title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <button type="button" class="btn btn-sm btn-outline-primary" title="Print Invoice">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                <a href="{{ route('orders.show', 1003) }}" class="btn btn-sm btn-outline-info"
                                   title="View">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('orders.edit', 1003) }}" class="btn btn-sm btn-outline-warning"
                                   title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <button type="button" class="btn btn-sm btn-outline-primary" title="Print Invoice">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                <a href="{{ route('orders.show', 1004) }}" class="btn btn-sm btn-outline-info"
                                   title="View">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('orders.edit', 1004) }}" class="btn btn-sm btn-outline-warning"
                                   title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
