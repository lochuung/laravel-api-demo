    ...
    public function messages(): array
    {
        return [
            ...
            'unit_name.max' => __(
                ...
                ['attribute' => __('validation.attributes.unit_name'), 'max' => 255]
            ),
            ...
            'conversion_rate.required' => __(
                'validation.required',
                ['attribute' => __('validation.attributes.conversion_rate')]
            ),
            'conversion_rate.numeric' => __(
                'validation.numeric',
                ['attribute' => __('validation.attributes.conversion_rate')]
            ),
            'conversion_rate.min' => __(
                'validation.min.numeric',
                ['attribute' => __('validation.attributes.conversion_rate'), 'min' => 0.0001]
            ),

            'selling_price.required' => __(
                'validation.required',
                ['attribute' => __('validation.attributes.selling_price')]
            ),
            'selling_price.numeric' => __(
                'validation.numeric',
                ['attribute' => __('validation.attributes.selling_price')]
            ),
            'selling_price.min' => __(
                'validation.min.numeric',
                ['attribute' => __('validation.attributes.selling_price'), 'min' => 0]
            ),

            'is_base_unit.required' => __(
                'validation.required',
                ['attribute' => __('validation.attributes.is_base_unit')]
            ),
